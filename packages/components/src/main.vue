...
const props = withDefaults(defineProps<{
    ...
    transparent: true,
    wireframe: false,
    texture: 'https://github.com/TodayCG/three-earth-vue/blob/main/packages/components/src/assets/Earth.png?raw=true',
    animation: true,
    ...
    apertureTexture: 'https://github.com/TodayCG/three-earth-vue/blob/main/packages/components/src/assets/Aperture.png?raw=true',
    cloudCover: false,
    cloudCoverColor: '#ffffff',
    cloudCoverOpacity: 1,
    cloudCoverTransparent: true,
    cloudCoverTexture: 'https://github.com/TodayCG/three-earth-vue/blob/main/packages/components/src/assets/CloudCover.png?raw=true',
    cloudCoverAnimation: true,
    cloudCoverAnimationSpeed: 0.0003,
    starrySky: false,
    starrySkyTexture: 'https://github.com/TodayCG/three-earth-vue/blob/main/packages/components/src/assets/StarrySky.png?raw=true',
