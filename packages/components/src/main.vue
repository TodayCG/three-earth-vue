...
const props = withDefaults(defineProps<{
    ...
    transparent: true,
    wireframe: false,
    // texture: 'http://172.16.16.166/update/resource/texture/Earth.png',
    ...
    apertureTexture: 'http://172.16.16.166/update/resource/texture/Aperture.png',
    cloudCover: false,
    cloudCoverColor: '#ffffff',
    cloudCoverOpacity: 1,
    cloudCoverTransparent: true,
    cloudCoverTexture: 'http://172.16.16.166/update/resource/texture/CloudCover.png',
    cloudCoverAnimation: true,
    cloudCoverAnimationSpeed: 0.0003,
    starrySky: false,
    starrySkyTexture: 'http://172.16.16.166/update/resource/texture/StarrySky.png',
